...
/* EMERGENCY BANNER */
#ebanner{position:sticky;top:0;left:0;right:0;width:100vw;max-width:100%;margin:0;border-radius:0;z-index:950;height:var(--ban-h);background:var(--red);display:flex;align-items:center;justify-content:space-between;padding:0 60px;}
...
/* NAV */
nav{position:sticky;top:var(--ban-h);left:0;right:0;width:100vw;max-width:100%;margin:0;border-radius:0;z-index:900;height:var(--nav-h);display:flex;align-items:center;justify-content:space-between;padding:0 60px;background:rgba(5,12,26,.95);backdrop-filter:blur(24px);border-bottom:1px solid var(--border);}
...
.mob-menu{display:none;position:fixed;top:calc(var(--ban-h)+var(--nav-h));left:0;width:100vw;max-width:100%;margin:0;z-index:890;background:rgba(5,12,26,.98);backdrop-filter:blur(20px);border-bottom:1px solid var(--border);flex-direction:column;padding:18px 24px 26px;}
...
/* MARQUEE */
.marquee-wrap{width:100vw;max-width:100%;margin:0;border-radius:0;padding:15px 0;background:var(--mint);overflow:hidden;}
